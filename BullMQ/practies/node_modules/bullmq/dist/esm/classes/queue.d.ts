...
import { JobScheduler } from 'bullmq/dist/esm/classes/job-scheduler';
import { QueueGetters } from 'bullmq/dist/esm/classes/queue-getters';
import { RedisConnection } from 'bullmq/dist/esm/classes/redis-connection';
import { Repeat } from 'bullmq/dist/esm/classes/repeat';
import { BaseJobOptions, BulkJobOptions, IoredisListener, QueueOptions, RepeatableJob, RepeatOptions } from 'bullmq/dist/esm/interfaces';
import { FinishedStatus, JobsOptions } from 'bullmq/dist/esm/types';
...
export declare class Queue<DataTypeOrJob = any, DefaultResultType = any, DefaultNameType extends string = string, DataType = ExtractDataType<DataTypeOrJob, DataTypeOrJob>, ResultType = ExtractResultType<DataTypeOrJob, DefaultResultType>, NameType extends string = ExtractNameType<DataTypeOrJob, DefaultNameType>> extends QueueGetters<JobBase<DataTypeOrJob, ResultType, NameType>> {
     ...
     */
    getJobScheduler(id: string): Promise<RepeatableJob>;
    /**
     ...
     * next execution time.
     */
    getJobSchedulers(start?: number, end?: number, asc?: boolean): Promise<RepeatableJob[]>;
    /**
     *
