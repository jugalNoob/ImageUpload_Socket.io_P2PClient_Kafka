import type { QueueEvents } from 'bullmq/dist/esm/classes/queue-events';
import { Scripts } from 'bullmq/dist/esm/classes/scripts';
import { BulkJobOptions, DependenciesOpts, JobJson, JobJsonRaw, MinimalJob, MoveToWaitingChildrenOpts, ParentKeys, ParentOpts, RedisClient } from 'bullmq/dist/esm/interfaces';
import { FinishedStatus, JobJsonSandbox, JobsOptions, JobState, MinimalQueue } from 'bullmq/dist/esm/types';
