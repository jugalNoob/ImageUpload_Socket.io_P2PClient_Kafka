...
import { JobJson, JobJsonRaw, KeepJobs, MinimalJob, MoveToDelayedOpts, MoveToWaitingChildrenOpts, ParentOpts, RedisClient, RepeatableOptions } from 'bullmq/dist/esm/interfaces';
import { FinishedPropValAttribute, FinishedStatus, JobState, JobType, MinimalQueue, RedisJobOptions } from 'bullmq/dist/esm/types';
...
export declare class Scripts {
    ...
    addJobScheduler(client: RedisClient, jobSchedulerId: string, nextMillis: number, opts: RepeatableOptions): Promise<string>;
